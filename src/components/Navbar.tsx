...
const Navbar = () => {
  ...
  const [loggedUser, setLoggedUser, logout] : [ClientUser | null, any, Function] = useContext(AuthContext);
          ...
          <div className="flex items-center px-2 lg:px-0">
            ...
            <div className="hidden lg:block lg:ml-6">
              <div className="flex space-x-4">
                <Link to="/" href="#" className="bg-green-900 text-white px-3 py-2 rounded-md text-sm font-medium">
                  Home
                </Link>
                  ...
                  <div className="ml-4 relative flex-shrink-0">
                    <div>
                      <button
                        ...
                        aria-expanded="false"
                        aria-haspopup="true"
                        onClick={() => setShowProfilePopUpMenu(!showProfilePopUpMenu)}
                      >
              ...
              <Then>
                <div className="pt-4 pb-3 border-t border-green-700">
                  <div className="flex items-center px-5">
                    ...
                    <div className="ml-3">
                      <div className="text-base font-medium text-white">{loggedUser?.username}</div>
                      <div className="text-sm font-medium text-gray-400">{loggedUser?.email}</div>
                    </div>
                  </div>
