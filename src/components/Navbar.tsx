        ...
        <div className='relative flex items-center justify-between h-16'>
          ...
          <div className='hidden lg:block lg:ml-4'>
            <div className='flex items-center'>
              <button className='flex-shrink-0 bg-green-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white'>
      ...
      <div className='lg:hidden' id='mobile-menu'>
        ...
        <div className='pt-4 pb-3 border-t border-green-700'>
          <div className='flex items-center px-5'>
            ...
            <button className='ml-auto flex-shrink-0 bg-green-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white'>
              <span className='sr-only'>View notifications</span>
              <svg
                className='h-6 w-6'
                xmlns='http://www.w3.org/2000/svg'
